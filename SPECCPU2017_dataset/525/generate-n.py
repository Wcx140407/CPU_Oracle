def generate_script(n):
    # 文件名
    filename = f"run_525.x264_r_ref-{n}.sh"
...
"""
    ...
    for i in range(1, n):
        script_content += f"../run_base_refrate_mytest-m64.0000/x264_r --pass 1 --stats x264_stats.log --bitrate 1000 --frames 1000 -o BuckBunny_New.264 BuckBunny.yuv 1280x720 > run_000-1000_x264_r_base.mytest-m64_x264_pass1.out 2>> run_000-1000_x264_r_base.mytest-m64_x264_pass1.err &\n"
    script_content += f"../run_base_refrate_mytest-m64.0000/x264_r --pass 1 --stats x264_stats.log --bitrate 1000 --frames 1000 -o BuckBunny_New.264 BuckBunny.yuv 1280x720 > run_000-1000_x264_r_base.mytest-m64_x264_pass1.out 2>> run_000-1000_x264_r_base.mytest-m64_x264_pass1.err\n"
    ...
    for i in range(1, n):
        script_content += f"../run_base_refrate_mytest-m64.0000/x264_r --seek 23 --dumpyuv 200 --frames 629 -o BuckBunny_New.264 BuckBunny.yuv 1280x720 > run_0500-1250_x264_r_base.mytest-m64_x264.out 2>> run_0500-1250_x264_r_base.mytest-m64_x264.err &\n"
    script_content += f"../run_base_refrate_mytest-m64.0000/x264_r --seek 23 --dumpyuv 200 --frames 629 -o BuckBunny_New.264 BuckBunny.yuv 1280x720 > run_0500-1250_x264_r_base.mytest-m64_x264.out 2>> run_0500-1250_x264_r_base.mytest-m64_x264.err\n"
