def generate_script(n):
    # 文件名
    filename = f"run_554.roms_r_ref-{n}.sh"
...
"""
    ...
    for i in range(1, n):
        script_content += f"../run_base_refrate_mytest-m64.0000/roms_r < ocean_benchmark2.in.x > ocean_benchmark2.log 2>> ocean_benchmark2.err &\n"
    script_content += f"../run_base_refrate_mytest-m64.0000/roms_r < ocean_benchmark2.in.x > ocean_benchmark2.log 2>> ocean_benchmark2.err\n"
