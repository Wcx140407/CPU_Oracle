def generate_script(n):
    # 文件名
    filename = f"run_526.blender_r_ref-{n}.sh"
...
"""
    ...
    for i in range(1, n):
        script_content += f"../run_base_refrate_mytest-m64.0000/blender_r sh3_no_char.blend --render-output sh3_no_char_ --threads 1 -b -F RAWTGA -s 861 -e 861 -a > sh3_no_char.849.spec.out 2>> sh3_no_char.849.spec.err &\n"
    script_content += f"../run_base_refrate_mytest-m64.0000/blender_r sh3_no_char.blend --render-output sh3_no_char_ --threads 1 -b -F RAWTGA -s 861 -e 861 -a > sh3_no_char.849.spec.out 2>> sh3_no_char.849.spec.err\n"
