def generate_script(n):
    # 文件名
    filename = f"run_520.omnetpp_r_ref-{n}.sh"
...
"""
    ...
    for i in range(1, n):
        script_content += f"../run_base_refrate_mytest-m64.0000/omnetpp_r -c General -r 0 > omnetpp.General-0.out 2>> omnetpp.General-0.err &\n"
    script_content += f"../run_base_refrate_mytest-m64.0000/omnetpp_r -c General -r 0 > omnetpp.General-0.out 2>> omnetpp.General-0.err\n"
