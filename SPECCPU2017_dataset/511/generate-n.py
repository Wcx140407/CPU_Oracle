def generate_script(n):
    # 文件名
    filename = f"run_511.povray_r_ref-{n}.sh"
...
"""
    ...
    for i in range(1, n):
        script_content += f"../run_base_refrate_mytest-m64.0000/povray_r SPEC-benchmark-ref.ini > SPEC-benchmark-ref.stdout 2>> SPEC-benchmark-ref.stderr &\n"
    script_content += f"../run_base_refrate_mytest-m64.0000/povray_r SPEC-benchmark-ref.ini > SPEC-benchmark-ref.stdout 2>> SPEC-benchmark-ref.stderr\n"
